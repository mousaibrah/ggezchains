...
var (
	...
	fd_QueryGetTradeIndexResponse_TradeIndex protoreflect.FieldDescriptor
)

func init() {
	file_ggezchain_trade_query_proto_init()
	md_QueryGetTradeIndexResponse = File_ggezchain_trade_query_proto.Messages().ByName("QueryGetTradeIndexResponse")
	fd_QueryGetTradeIndexResponse_TradeIndex = md_QueryGetTradeIndexResponse.Fields().ByName("TradeIndex")
}
...
func (x *fastReflection_QueryGetTradeIndexResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TradeIndex != nil {
		...
		if !f(fd_QueryGetTradeIndexResponse_TradeIndex, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryGetTradeIndexResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ggezchain.trade.QueryGetTradeIndexResponse.TradeIndex":
...
var (
	...
	fd_QueryGetStoredTradeRequest_tradeIndex protoreflect.FieldDescriptor
)

func init() {
	file_ggezchain_trade_query_proto_init()
	md_QueryGetStoredTradeRequest = File_ggezchain_trade_query_proto.Messages().ByName("QueryGetStoredTradeRequest")
	fd_QueryGetStoredTradeRequest_tradeIndex = md_QueryGetStoredTradeRequest.Fields().ByName("tradeIndex")
}
...
func (x *fastReflection_QueryGetStoredTradeRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ggezchain.trade.QueryGetStoredTradeRequest.tradeIndex":
		panic(fmt.Errorf("field tradeIndex of message ggezchain.trade.QueryGetStoredTradeRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ggezchain.trade.QueryGetStoredTradeRequest"))
		}
...
var (
	...
	fd_QueryGetStoredTradeResponse_storedTrade protoreflect.FieldDescriptor
)

func init() {
	file_ggezchain_trade_query_proto_init()
	md_QueryGetStoredTradeResponse = File_ggezchain_trade_query_proto.Messages().ByName("QueryGetStoredTradeResponse")
	fd_QueryGetStoredTradeResponse_storedTrade = md_QueryGetStoredTradeResponse.Fields().ByName("storedTrade")
}
...
func (x *fastReflection_QueryGetStoredTradeResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.StoredTrade != nil {
		...
		if !f(fd_QueryGetStoredTradeResponse_storedTrade, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryGetStoredTradeResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ggezchain.trade.QueryGetStoredTradeResponse.storedTrade":
...
var (
	...
	fd_QueryAllStoredTradeResponse_storedTrade protoreflect.FieldDescriptor
...
func init() {
	...
	fd_QueryAllStoredTradeResponse_storedTrade = md_QueryAllStoredTradeResponse.Fields().ByName("storedTrade")
...
func (x *fastReflection_QueryAllStoredTradeResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.StoredTrade) != 0 {
		...
		if !f(fd_QueryAllStoredTradeResponse_storedTrade, value) {
			return
		}
	}
	if x.Pagination != nil {
...
func (x *fastReflection_QueryAllStoredTradeResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ggezchain.trade.QueryAllStoredTradeResponse.storedTrade":
...
type QueryGetTradeIndexResponse struct {
	...
	TradeIndex *TradeIndex `protobuf:"bytes,1,opt,name=TradeIndex,proto3" json:"TradeIndex,omitempty"`
}
...
type QueryGetStoredTradeResponse struct {
	...
	StoredTrade *StoredTrade `protobuf:"bytes,1,opt,name=storedTrade,proto3" json:"storedTrade,omitempty"`
}
...
type QueryAllStoredTradeResponse struct {
	...
	StoredTrade []*StoredTrade        `protobuf:"bytes,1,rep,name=storedTrade,proto3" json:"storedTrade,omitempty"`
